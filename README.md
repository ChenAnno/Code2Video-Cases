...
> **Anonymous Repository** — Supplementary demo videos.
...
- Pixel-based models (e.g., Veo3) are limited to **~8 seconds** of output. In contrast, Code2Video generates **minute-level** educational videos with synchronized lecture lines and animations.
